...
//        if (controller1.x.wasJustPressed()) drivetrain.setTargetHeading(3 * Math.PI / 2);
        ...
        if (controller1.rightBumper.wasJustPressed()) elevator.setSetpoint(ElevatorConstants.WAYPOINT_READY);
        if (controller1.rightBumper.wasJustReleased()) elevator.setSetpoint(ElevatorConstants.WAYPOINT_PULL);
